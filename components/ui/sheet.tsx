  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === "right" &&
        "inset-y-0 right-0 h-full w-3/4 max-w-md data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-md",
        side === "left" &&
        "inset-y-0 left-0 h-full w-3/4 max-w-md data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-md",
        side === "top" &&
